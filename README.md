<div align="center">
  ...
  <p>
    한솔그룹 계열사 데이터 플랫폼의 AWS 멀티 어카운트 아키텍처를 설계하고,<br/>
    계정 생명주기와 멀티 테넌트 VPC·TGW 연동, 감사 중앙화같은 클라우드 거버넌스 전반을 운영하고 있습니다.<br/>
    MWAA 기반 DataOps 파이프라인을 구축하고, 병목을 개선하고 장애를 추적하며 데이터 플랫폼의 안정성을 높여가고 있습니다.
  </p>
</div>
